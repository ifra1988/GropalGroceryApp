...
public class BaseURL {
    ...
    public static String BASE_URL = "https://www.gropal.in/";
    ...
    public static String GET_BANNERS_URL = BASE_URL + "index.php/api/get_banners";
    ...
    public static String GET_NEW_BANNER_URL = BASE_URL + "uploads/banners/";
    ...
    public static String GET_Call = BASE_URL + "index.php/api/contact_numbers";
    public static String GET_ALL_TOP_SELLING_PRODUCTS = BASE_URL + "index.php/api/get_all_top_selling_product";
    public static String GET_SIMILAR_PRODUCTS = BASE_URL + "index.php/api/get_similar_products";
    public static String GET_RELATED_PRODUCTS = BASE_URL + "index.php/api/get_related_products";
    ...
    public static String SEND_OTP = BASE_URL + "index.php/api/send_otp";
    public static String VERIFY_OTP = BASE_URL + "index.php/api/verify_otp";
