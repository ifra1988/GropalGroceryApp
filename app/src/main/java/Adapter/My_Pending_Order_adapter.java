...
public class My_Pending_Order_adapter extends RecyclerView.Adapter<My_Pending_Order_adapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        public TextView tv_orderno, tv_status, tv_date, tv_time, tv_price, tv_item, tv_tracking_date;
        ...
        public MyViewHolder(View view) {
            ...
            relativetextstatus =  view.findViewById(R.id.relativetextstatus);
