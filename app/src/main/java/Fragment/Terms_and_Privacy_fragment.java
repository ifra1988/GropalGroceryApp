...
public class Terms_and_Privacy_fragment extends Fragment {

    private static String TAG = Terms_and_Privacy_fragment.class.getSimpleName();

    private TextView tv_terms;

    public Terms_and_Privacy_fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ((MainActivity) getActivity()).setToolbarTitle(getResources().getString(R.string.nav_terms));

        // check internet connection
        if (ConnectivityReceiver.isConnected()) {
           // makeGetInfoRequest(BaseURL.GET_TERMS_URL);
        } else {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if (status) {
                        ...
                        tv_terms.setText(Html.fromHtml(desc));
