...
String language;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ((MainActivity) getActivity()).setToolbarTitle(getResources().getString(R.string.delivery));
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if (status) {
                        ...
                        Log.e("delivery_address",""+response.getString("data").toString());

                        delivery_address_modelList.addAll((Collection<? extends Delivery_address_model>) gson.fromJson(response.getString("data"), listType));
